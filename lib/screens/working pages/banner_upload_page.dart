...
class BannerProfileUplaod extends StatefulWidget {
  const BannerProfileUplaod({Key? key}) : super(key: key);

  @override
  State<BannerProfileUplaod> createState() => _BannerProfileUplaodState();
}

class _BannerProfileUplaodState extends State<BannerProfileUplaod> {
  var _profileImage;
                      ...
                      Padding(
                        ...
                        child: BiggerButton(
                          onPressed: () async {
                            ...
                            await DataBase().saveProfileBanner(
                              imageUrl: url,
                            );
                          },
                          title: 'upload Image',
